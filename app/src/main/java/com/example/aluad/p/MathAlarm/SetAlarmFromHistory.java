...
import com.example.aluad.p.SQLDataBase.AlarmDBValues;
...
public class SetAlarmFromHistory extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private ImageButton ibHistoryDeleteAllAlarms;
    private TextView ibDeleteChosenRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibDeleteChosenRow = (TextView) findViewById(R.id.ibDeleteChosenRow);
        ibHistoryDeleteAllAlarms = (ImageButton) findViewById(R.id.Add);
    ...
    public void imHistoryDeleteAllAlarms_OnClickMethod(View view) {
        startActivity(new Intent(this,MainMathAlarm.class));
    }
