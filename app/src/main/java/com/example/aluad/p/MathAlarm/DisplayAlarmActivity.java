...
import com.example.aluad.p.MathAlarmTaskGenerator;
...
public class DisplayAlarmActivity extends AppCompatActivity {
        ...
        switch (alarmComplexityLevel) {
            case 0:
                ...
                if (ShowLogsOld.LOG_STATUS)
                    ShowLogsOld.i("DisplayAlarmActivity " + "Easy:" + String.valueOf(iAnswer));
                break;
            ...
            case 1:
                ...
                if (ShowLogsOld.LOG_STATUS)
                    ShowLogsOld.i("DisplayAlarmActivity " + "Medium:" + String.valueOf(iAnswer));
                break;
            case 2:
                ...
                if (ShowLogsOld.LOG_STATUS)
                    ShowLogsOld.i("DisplayAlarmActivity " + "Hard:" + String.valueOf(iAnswer));
                break;
            ...
            default:
                if (ShowLogsOld.LOG_STATUS)
                    ShowLogsOld.i("DisplayAlarmActivity " + "default (complexity error):" + iAnswer);
                break;
        }
    }
    ...
    private void CheckAnswer_Method(String answer) {
        if (answer != null && !answer.equals("")) {
            ...
            if (iGetUserAnswer == iAnswer) {
                ...
                if (ShowLogsOld.LOG_STATUS)
                    ShowLogsOld.i("DisplayAlarmActivity CheckAnswer_Method " + "iGetUserAnswer==iAnswer " + iGetUserAnswer + " == " + iAnswer);
                checkAlarmState_Method();
    ...
    private void checkAlarmState_Method() {
        ...
        if (onOffMusicPlayingRemember)
            ...
            if (ShowLogsOld.LOG_STATUS)
                ShowLogsOld.i("DisplayAlarmActivity checkAlarmState_Method " + " Alarm wasn't set");
        }
    }
    ...
    private void stopServices() {
        ...
        Intent intent_startMainActivity = new Intent(DisplayAlarmActivity.this, SetAlarmFromHistory.class);
    ...
    public void bSnoozeAlarm_OnClickListener(View view) {
        ...
        snoozeIntent.setClass(this, Alarm_Receiver.class);
